...
function updateKeyboardState(){
  ...
  _kbdRaf = requestAnimationFrame(()=>{
    ...
    function openDetail(id){
      // Redirect to dedicated preview page
      const url = new URL("./preview/", location.href);
            ...
            <div>
              ...
              <div class="editor" id="reviewEditor" aria-hidden="true">
                ...
                <div class="hint" style="margin-top:8px">
                  1 akun Google = 1 ulasan. Edit terkunci 30 dtk setelah kirim. <span id="charInfo" class="hint"></span>
                </div>
              </div>
            </div>
          </div>
